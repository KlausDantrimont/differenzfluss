...
## Entstehung (Metaebene)

Die Idee für diesen Ordner entstand selbst im **Differenzfluss**:
Beim Austausch zeigte sich eine Kommunikationsstörung – die DFT setzte eine Brille voraus, die nicht alle automatisch aufhatten.

Die Lösung war, eine **Adapter-Schicht** einzuführen: kleine Dossiers, die den Anschluss an Bekanntes herstellen.
