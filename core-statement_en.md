...
Differentiation Flow Theory (DFT) is a minimal, operative grammar for the formation of complex, recursive structures.
It describes how *differences*, repeatedly transformed under *context*, *stabilisation*, and *similarity*, generate order, meaning, and emergent patterns.
...
but it describes **the generative logic common to everything**:
