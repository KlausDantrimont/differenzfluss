...
**Antwort:**
Es sind nicht beliebige Fragen.
Beliebige Fragen sind offen, ungerichtet.
Die DFT-Fragen dagegen haben eine **Form**:
Sie nehmen immer Differenz + Fluss in den Blick.

* *„Was ist die Differenz?“* → zwingt, Unterschiede sichtbar zu machen.
* *„Was fließt?“* → richtet den Blick auf Dynamik.
* *„Wo stabilisiert sich etwas?“* → sucht nach Fixpunkten.
* *„Welche Regel differenziert gerade?“* → fragt nach dem Meta-Operator.
* *„Wo ist das Interface?“* → lenkt auf Übergänge.
* *„Was geschieht beim Maßstabwechsel?“* → thematisiert Rekursion und Skalen.

Das ist eine **Strukturmenge von Leitfragen**, keine Willkür.
Sie sind so gewählt, dass sie jede Situation auf die Grundoperationen von **Differenz, Fluss, Stabilisierung, Meta-Differenzierung, Interface, Skala** herunterbrechen.

---

👉 Kurz:
**Die Fragen sind nicht beliebig – sie sind wie Axiome einer Brille.**
