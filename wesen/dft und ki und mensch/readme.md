# DFT und KI – Begriffe im Differenzfluss

Dieses Repository enthält Module zur Verbindung der **Differenzflusstheorie (DFT)** mit Konzepten maschinellen Lernens, semantischer Modellierung und diskursiver Dynamik. Im Fokus stehen **Begriffe als dynamische Differenzstrukturen**, ihre **Verbreitung**, **Mutation** und **Simulation** – sowohl in menschlichen als auch in maschinellen Systemen.
...
Dieses Projekt ist Teil einer größeren Forschung zur DFT. Ziel ist es, das **Begriffsgeschehen sichtbar, verstehbar und gestaltbar** zu machen – für Mensch und Maschine.

## Lizenz

Nutzung, Veränderung und Weitergabe ausdrücklich erwünscht – unter Nennung der Quelle. Ideen möchten sich vermehren.
